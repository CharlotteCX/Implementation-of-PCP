...
#line 5 "Preparation.c"


osThreadId tid_thread5;          
	
uint8_t task_stack_thread5[300]; osThreadDef_t os_thread_def_thread5 = { ( (uint8_t *) &(task_stack_thread5)), (thread5), (osPriorityLow), (300) };  
...
int Init_thread5 (void) 
{
    tid_thread5 = osThreadCreate (&os_thread_def_thread5, 0);
...
uint8_t task_stack_thread4[300]; osThreadDef_t os_thread_def_thread4 = { ( (uint8_t *) &(task_stack_thread4)), (thread4), (osPriorityIdle), (300) };  
...
int Init_thread4 (void) 
{
    tid_thread4 = osThreadCreate (&os_thread_def_thread4, 0);
...
uint8_t task_stack_thread3[300]; osThreadDef_t os_thread_def_thread3 = { ( (uint8_t *) &(task_stack_thread3)), (thread3), (osPriorityIdle), (300) };  
...
int Init_thread3 (void) 
{
    tid_thread3 = osThreadCreate (&os_thread_def_thread3, 0);
...
uint8_t task_stack_thread2[300]; osThreadDef_t os_thread_def_thread2 = { ( (uint8_t *) &(task_stack_thread2)), (thread2), (osPriorityIdle), (300) };  
...
int Init_thread2 (void) 
{	
    tid_thread2 = osThreadCreate (&os_thread_def_thread2, 0);
