#line 1 "RTE\\RTOS\\Source\\peripherals.c"
...
#line 7 "RTE\\RTOS\\Source\\peripherals.c"
...
#line 8 "RTE\\RTOS\\Source\\peripherals.c"
...
#line 9 "RTE\\RTOS\\Source\\peripherals.c"
...
void LED_initialize(void)
{
	((SYSCTL_Type *) 0x400FE000UL)->RCGCGPIO |= (1UL << 5);   

	
	
	
	
	((GPIOA_Type *) 0x40025000UL)->DIR = ((GPIOA_Type *) 0x40025000UL)->DIR | 0x00000008 | 0x00000002 | 0x00000004;
	((GPIOA_Type *) 0x40025000UL)->DEN = ((GPIOA_Type *) 0x40025000UL)->DEN | 0x00000008 | 0x00000002 | 0x00000004;
...
void protected_LED_blink( uint32_t id )
{
	...
	__disable_irq();
  ((GPIOA_Type *) 0x40025000UL)->DATA ^= led;  
	__enable_irq();
...
void UART_initialize(void)
{
  ...
  Driver_USART0.PowerControl(ARM_POWER_FULL);
	...
	Driver_USART0.Control((0x01UL << 0),115200);
	Driver_USART0.Control((0x15UL << 0),1);
