#line 1 "RTE\\RTOS\\Source\\threadIdle.c"
...
#line 8 "RTE\\RTOS\\Source\\threadIdle.c"
...
#line 9 "RTE\\RTOS\\Source\\threadIdle.c"
...
#line 10 "RTE\\RTOS\\Source\\threadIdle.c"
...
#line 11 "RTE\\RTOS\\Source\\threadIdle.c"

uint8_t task_stack_threadIdle[300]; osThreadDef_t os_thread_def_threadIdle = { ( (uint8_t *) &(task_stack_threadIdle)), (threadIdle), (osPriorityIdle), (300) };  
...
int Init_threadIdle (void) 
{
  ...
  tid_threadIdle = osThreadCreate (&os_thread_def_threadIdle, 0);
...
{ 
	...
	dumpTraceProtected();
	if (addTraceProtected("threadIdle dumped trace") != 0)
	{
		while(1) { };
	}
}
