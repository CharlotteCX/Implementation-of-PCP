#line 1 "RTE\\Application\\source\\thread0.c"
...
#line 7 "RTE\\Application\\source\\thread0.c"
...
#line 8 "RTE\\Application\\source\\thread0.c"
...
#line 9 "RTE\\Application\\source\\thread0.c"
...
#line 10 "RTE\\Application\\source\\thread0.c"



uint8_t task_stack_thread0[300]; osThreadDef_t os_thread_def_thread0 = { ( (uint8_t *) &(task_stack_thread0)), (thread0), (osPriorityHigh), (300) };  
...
{   uint32_t i;
    ...
    {	
        ...
        if (osSemaphoreWait (sid_Semaphore0, 0xFFFFFFFF) >= 0 ) 
        {                   
